...
from pcrl.algorithms.common.policies import MaskableActorCriticCnnPolicy, MaskableActorCriticPolicy, MaskableMultiInputActorCriticPolicy
from pcrl.algorithms.common.utils import get_action_masks, is_masking_supported
...
class MaskablePPO(OnPolicyAlgorithm):
    ...
    def _init_callback(
        ...
        if eval_env is not None:
            ...
            from sb3_contrib.common.callbacks import MaskableEvalCallback
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if self.normalize_advantage:
                    ...
                    advantages = adv.reshape(*adv_shape)#(advantages - advantages.mean()) / (advantages.std() + 1e-8)
        ...
        train_info = {
            ...
            "ppo/clip_fraction": np.mean(clip_fractions).item(),
            "ppo/loss": loss.item(),
            "ppo/clip_range": clip_range,
            "ppo/n_updates": self._n_updates,
        }
